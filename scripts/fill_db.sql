...
insert into question (text) values ('Вы пользуетесь компьютером по работе?');
...
insert into question (text) values ('Вы общительный?');
insert into question (text) values ('Вы работаете в цирке');
...
insert into question (text) values ('Вы работаете с документами?');
insert into question (text) values ('Вы работаете в школе?');
...
insert into profession (id, name) values (2, 'Клоун');
insert into profession (id, name) values (3, 'Учитель');
insert into profession (id, name) values (4, 'Сварщик');
insert into profession (id, name) values (5,'Альпинист');
insert into profession (id, name) values (6,'Сисадмин');
insert into profession (id, name) values (7,'Продавец');
insert into profession (id, name) values (8,'Формашлеп');
insert into profession (id, name) values (9,'Юрист');
insert into profession (id, name) values (10,'Уборщик');
insert into profession (id, name) values (11,'Архитектор');
insert into profession (id, name) values (12,'Строитель');
insert into profession (id, name) values (13,'Менеджер по продажам');
insert into profession (id, name) values (14,'HR');
insert into profession (id, name) values (15,'Бэкенд разработчик');
insert into profession (id, name) values (16,'Дизайнер');
insert into profession (id, name) values (17,'Тестировщик');
insert into profession (id, name) values (18,'Data scientist');

insert into answer(id, text) values ('Да');
insert into answer(id, text) values ('Нет');
insert into answer(id, text) values ('Не совсем');
